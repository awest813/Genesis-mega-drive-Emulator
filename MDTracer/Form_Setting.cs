...
namespace MDTracer
{
    public partial class Form_Setting : Form
    {
        ...
        {
            if (md_main.g_screenA_enable == true) { WinFormsDebugTools.g_form_screenA.Show(); } else { WinFormsDebugTools.g_form_screenA.Hide(); }
            if (md_main.g_screenB_enable == true) { WinFormsDebugTools.g_form_screenB.Show(); } else { WinFormsDebugTools.g_form_screenB.Hide(); }
            if (md_main.g_screenW_enable == true) { WinFormsDebugTools.g_form_screenW.Show(); } else { WinFormsDebugTools.g_form_screenW.Hide(); }
            if (md_main.g_screenS_enable == true) { WinFormsDebugTools.g_form_screenS.Show(); } else { WinFormsDebugTools.g_form_screenS.Hide(); }
            if (md_main.g_pattern_enable == true) { WinFormsDebugTools.g_form_pattern.Show(); } else { WinFormsDebugTools.g_form_pattern.Hide(); }
            if (md_main.g_pallete_enable == true) { WinFormsDebugTools.g_form_pallete.Show(); } else { WinFormsDebugTools.g_form_pallete.Hide(); }
            if (md_main.g_code_enable == true) { WinFormsDebugTools.g_form_code.Show(); } else { WinFormsDebugTools.g_form_code.Hide(); }
            if (md_main.g_io_enable == true) { WinFormsDebugTools.g_form_io.Show(); } else { WinFormsDebugTools.g_form_io.Hide(); }
            if (md_main.g_music_enable == true) { WinFormsDebugTools.g_form_music.Show(); } else { WinFormsDebugTools.g_form_music.Hide(); }
            if (md_main.g_registry_enable == true) { WinFormsDebugTools.g_form_registry.Show(); } else { WinFormsDebugTools.g_form_registry.Hide(); }
            if (md_main.g_flow_enable == true) { WinFormsDebugTools.g_form_flow.Show(); } else { WinFormsDebugTools.g_form_flow.Hide(); }
        }
